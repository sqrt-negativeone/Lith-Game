...
#define HMM_PREFIX(name) HMM_##name
    ...
    COVERAGE(HMM_dVec2, 1)
        HMM_INLINE hmm_dVec2 HMM_PREFIX(dVec2)(double X, double Y)
    {
        ASSERT_COVERED(HMM_dVec2);
    ...
    COVERAGE(HMM_dAddVec2, 1)
        HMM_INLINE hmm_dVec2 HMM_PREFIX(dAddVec2)(hmm_dVec2 Left, hmm_dVec2 Right)
    {
        ASSERT_COVERED(HMM_dAddVec2);
    ...
    COVERAGE(HMM_dSubtractVec2, 1)
        HMM_INLINE hmm_dVec2 HMM_PREFIX(dSubtractVec2)(hmm_dVec2 Left, hmm_dVec2 Right)
    {
        ASSERT_COVERED(HMM_dSubtractVec2);
    ...
    COVERAGE(HMM_dMultiplyVec2, 1)
        HMM_INLINE hmm_dVec2 HMM_PREFIX(dMultiplyVec2)(hmm_dVec2 Left, hmm_dVec2 Right)
    {
        ASSERT_COVERED(HMM_dMultiplyVec2);
    ...
    COVERAGE(HMM_dMultiplyVec2f, 1)
        HMM_INLINE hmm_dVec2 HMM_PREFIX(dMultiplyVec2f)(hmm_dVec2 Left, float Right)
    {
        ASSERT_COVERED(HMM_dMultiplyVec2f);
    ...
    COVERAGE(HMM_dMultiplyVec2d, 1)
        HMM_INLINE hmm_dVec2 HMM_PREFIX(dMultiplyVec2d)(hmm_dVec2 Left, double Right)
    {
        ASSERT_COVERED(HMM_dMultiplyVec2f);
    ...
    COVERAGE(HMM_dDivideVec2, 1)
        HMM_INLINE hmm_dVec2 HMM_PREFIX(dDivideVec2)(hmm_dVec2 Left, hmm_dVec2 Right)
    {
        ASSERT_COVERED(HMM_dDivideVec2);
    ...
    COVERAGE(HMM_dDivideVec2f, 1)
        HMM_INLINE hmm_dVec2 HMM_PREFIX(dDivideVec2f)(hmm_dVec2 Left, float Right)
    {
        ASSERT_COVERED(HMM_dDivideVec2f);
    ...
    COVERAGE(HMM_dDivideVec2d, 1)
        HMM_INLINE hmm_dVec2 HMM_PREFIX(dDivideVec2d)(hmm_dVec2 Left, double Right)
    {
        ASSERT_COVERED(HMM_dDivideVec2d);
    ...
    COVERAGE(HMM_dEqualsVec2, 1)
        HMM_INLINE hmm_bool HMM_PREFIX(dEqualsVec2)(hmm_dVec2 Left, hmm_dVec2 Right)
    {
        ASSERT_COVERED(HMM_dEqualsVec2);
    ...
    COVERAGE(HMM_dDotVec2, 1)
        HMM_INLINE double HMM_PREFIX(dDotVec2)(hmm_dVec2 VecOne, hmm_dVec2 VecTwo)
    {
        ASSERT_COVERED(HMM_dDotVec2);
    ...
    COVERAGE(HMM_dLengthSquaredVec2, 1)
        HMM_INLINE double HMM_PREFIX(dLengthSquaredVec2)(hmm_dVec2 A)
    {
        ASSERT_COVERED(HMM_dLengthSquaredVec2);
        
        double Result = HMM_PREFIX(dDotVec2)(A, A);
    ...
    {
        ASSERT_COVERED(HMM_dLengthVec2);
    ...
    COVERAGE(HMM_dLengthVec2, 1)
        HMM_INLINE float HMM_PREFIX(dLengthVec2)(hmm_dVec2 A)
    {
        ASSERT_COVERED(HMM_dLengthVec2);
        
        float Result = HMM_PREFIX(SquareRootF)((float)HMM_PREFIX(dLengthSquaredVec2)(A));
    ...
    COVERAGE(HMM_dNormalizeVec2, 2)
        HMM_INLINE hmm_dVec2 HMM_PREFIX(dNormalizeVec2)(hmm_dVec2 A)
    {
        ASSERT_COVERED(HMM_dNormalizeVec2);
        
        hmm_dVec2 Result = {0};
        
        double VectorLength = HMM_PREFIX(dLengthVec2)(A);
    ...
    COVERAGE(HMM_dFastNormalizeVec2, 1)
        HMM_INLINE hmm_dVec2 HMM_PREFIX(dFastNormalizeVec2)(hmm_dVec2 A)
    {
        ASSERT_COVERED(HMM_dFastNormalizeVec2);
        
        return HMM_PREFIX(dMultiplyVec2f)(A, HMM_PREFIX(RSquareRootF)((float)HMM_PREFIX(dDotVec2)(A, A)));
    }
...
COVERAGE(HMM_LengthVec2CPPd, 1)
HMM_INLINE double HMM_PREFIX(Length)(hmm_dVec2 A)
{
    ASSERT_COVERED(HMM_LengthVec2CPPd);
    
    double Result = HMM_PREFIX(dLengthVec2)(A);
    return (Result);
}
...
COVERAGE(HMM_LengthSquaredVec2CPPd, 1)
HMM_INLINE double HMM_PREFIX(LengthSquared)(hmm_dVec2 A)
{
    ASSERT_COVERED(HMM_LengthSquaredVec2CPPd);
    
    double Result = HMM_PREFIX(dLengthSquaredVec2)(A);
...
COVERAGE(HMM_dNormalizeVec2CPP, 1)
HMM_INLINE hmm_dVec2 HMM_PREFIX(Normalize)(hmm_dVec2 A)
{
    ASSERT_COVERED(HMM_dNormalizeVec2CPP);
    
    hmm_dVec2 Result = HMM_PREFIX(dNormalizeVec2)(A);
...
COVERAGE(HMM_dFastNormalizeVec2CPP, 1)
HMM_INLINE hmm_dVec2 HMM_PREFIX(FastNormalize)(hmm_dVec2 A)
{
    ASSERT_COVERED(HMM_dFastNormalizeVec2CPP);
    
    hmm_dVec2 Result = HMM_PREFIX(dFastNormalizeVec2)(A);
...
COVERAGE(HMM_dDotVec2CPP, 1)
HMM_INLINE double HMM_PREFIX(Dot)(hmm_dVec2 VecOne, hmm_dVec2 VecTwo)
{
    ASSERT_COVERED(HMM_dDotVec2CPP);
    
    double Result = HMM_PREFIX(dDotVec2)(VecOne, VecTwo);
...
COVERAGE(HMM_dAddVec2CPP, 1)
HMM_INLINE hmm_dVec2 HMM_PREFIX(Add)(hmm_dVec2 Left, hmm_dVec2 Right)
{
    ASSERT_COVERED(HMM_dAddVec2CPP);
    
    hmm_dVec2 Result = HMM_PREFIX(dAddVec2)(Left, Right);
...
COVERAGE(HMM_dSubtractVec2CPP, 1)
HMM_INLINE hmm_dVec2 HMM_PREFIX(Subtract)(hmm_dVec2 Left, hmm_dVec2 Right)
{
    ASSERT_COVERED(HMM_dSubtractVec2CPP);
    
    hmm_dVec2 Result = HMM_PREFIX(dSubtractVec2)(Left, Right);
...
COVERAGE(HMM_dMultiplyVec2CPP, 1)
HMM_INLINE hmm_dVec2 HMM_PREFIX(Multiply)(hmm_dVec2 Left, hmm_dVec2 Right)
{
    ASSERT_COVERED(HMM_dMultiplyVec2CPP);
    
    hmm_dVec2 Result = HMM_PREFIX(dMultiplyVec2)(Left, Right);
...
COVERAGE(HMM_dMultiplyVec2fCPP, 1)
HMM_INLINE hmm_dVec2 HMM_PREFIX(Multiply)(hmm_dVec2 Left, float Right)
{
    ASSERT_COVERED(HMM_dMultiplyVec2fCPP);
    
    hmm_dVec2 Result = HMM_PREFIX(dMultiplyVec2f)(Left, Right);
    
    return (Result);
}

COVERAGE(HMM_dMultiplyVec2dCPP, 1)
HMM_INLINE hmm_dVec2 HMM_PREFIX(Multiply)(hmm_dVec2 Left, double Right)
{
    ASSERT_COVERED(HMM_dMultiplyVec2dCPP);
    
    hmm_dVec2 Result = HMM_PREFIX(dMultiplyVec2d)(Left, Right);
...
COVERAGE(HMM_dDivideVec2CPP, 1)
HMM_INLINE hmm_dVec2 HMM_PREFIX(Divide)(hmm_dVec2 Left, hmm_dVec2 Right)
{
    ASSERT_COVERED(HMM_dDivideVec2CPP);
    
    hmm_dVec2 Result = HMM_PREFIX(dDivideVec2)(Left, Right);
...
COVERAGE(HMM_dDivideVec2fCPP, 1)
HMM_INLINE hmm_dVec2 HMM_PREFIX(Divide)(hmm_dVec2 Left, float Right)
{
    ASSERT_COVERED(HMM_dDivideVec2fCPP);
    
    hmm_dVec2 Result = HMM_PREFIX(dDivideVec2f)(Left, Right);
    
    return (Result);
}

COVERAGE(HMM_dDivideVec2dCPP, 1)
HMM_INLINE hmm_dVec2 HMM_PREFIX(Divide)(hmm_dVec2 Left, double Right)
{
    ASSERT_COVERED(HMM_dDivideVec2dCPP);
    
    hmm_dVec2 Result = HMM_PREFIX(dDivideVec2d)(Left, Right);
...
COVERAGE(HMM_dEqualsVec2CPP, 1)
HMM_INLINE hmm_bool HMM_PREFIX(Equals)(hmm_dVec2 Left, hmm_dVec2 Right)
{
    ASSERT_COVERED(HMM_aEqualsVec2CPP);
    
    hmm_bool Result = HMM_PREFIX(dEqualsVec2)(Left, Right);
...
COVERAGE(HMM_dAddVec2Op, 1)
HMM_INLINE hmm_dVec2 operator+(hmm_dVec2 Left, hmm_dVec2 Right)
{
    ASSERT_COVERED(HMM_dAddVec2Op);
...
COVERAGE(HMM_dSubtractVec2Op, 1)
HMM_INLINE hmm_dVec2 operator-(hmm_dVec2 Left, hmm_dVec2 Right)
{
    ASSERT_COVERED(HMM_dSubtractVec2Op);
...
COVERAGE(HMM_dMultiplyVec2Op, 1)
HMM_INLINE hmm_dVec2 operator*(hmm_dVec2 Left, hmm_dVec2 Right)
{
    ASSERT_COVERED(HMM_MultiplyVec2Op);
...
COVERAGE(HMM_dMultiplyVec2fOp, 1)
HMM_INLINE hmm_dVec2 operator*(hmm_dVec2 Left, float Right)
{
    ASSERT_COVERED(HMM_dMultiplyVec2fOp);
...
COVERAGE(HMM_dMultiplyVec2dOp, 1)
HMM_INLINE hmm_dVec2 operator*(hmm_dVec2 Left, double Right)
{
    ASSERT_COVERED(HMM_dMultiplyVec2fOp);
...
COVERAGE(HMM_dMultiplyVec2fOpLeft, 1)
HMM_INLINE hmm_dVec2 operator*(float Left, hmm_dVec2 Right)
{
    ASSERT_COVERED(HMM_dMultiplyVec2fOpLeft);
    
    hmm_dVec2 Result = HMM_PREFIX(dMultiplyVec2f)(Right, Left);
    
    return (Result);
}

COVERAGE(HMM_dMultiplyVec2dOpLeft, 1)
HMM_INLINE hmm_dVec2 operator*(double Left, hmm_dVec2 Right)
{
    ASSERT_COVERED(HMM_dMultiplyVec2fOpLeft);
    
    hmm_dVec2 Result = HMM_PREFIX(dMultiplyVec2d)(Right, Left);
...
COVERAGE(HMM_dDivideVec2Op, 1)
HMM_INLINE hmm_dVec2 operator/(hmm_dVec2 Left, hmm_dVec2 Right)
{
    ASSERT_COVERED(HMM_dDivideVec2Op);
...
COVERAGE(HMM_dDivideVec2fOp, 1)
HMM_INLINE hmm_dVec2 operator/(hmm_dVec2 Left, float Right)
{
    ASSERT_COVERED(HMM_dDivideVec2fOp);
...
COVERAGE(HMM_dDivideVec2dOp, 1)
HMM_INLINE hmm_dVec2 operator/(hmm_dVec2 Left, double Right)
{
    ASSERT_COVERED(HMM_dDivideVec2dOp);
...
COVERAGE(HMM_dAddVec2Assign, 1)
HMM_INLINE hmm_dVec2 &operator+=(hmm_dVec2 &Left, hmm_dVec2 Right)
{
    ASSERT_COVERED(HMM_dAddVec2Assign);
...
COVERAGE(HMM_dSubtractVec2Assign, 1)
HMM_INLINE hmm_dVec2 &operator-=(hmm_dVec2 &Left, hmm_dVec2 Right)
{
    ASSERT_COVERED(HMM_dSubtractVec2Assign);
...
COVERAGE(HMM_dMultiplyVec2Assign, 1)
HMM_INLINE hmm_dVec2 &operator*=(hmm_dVec2 &Left, hmm_dVec2 Right)
{
    ASSERT_COVERED(HMM_dMultiplyVec2Assign);
...
COVERAGE(HMM_dMultiplyVec2fAssign, 1)
HMM_INLINE hmm_dVec2 &operator*=(hmm_dVec2 &Left, float Right)
{
    ASSERT_COVERED(HMM_dMultiplyVec2fAssign);
    
    return (Left = Left * Right);
}

COVERAGE(HMM_dMultiplyVec2dAssign, 1)
HMM_INLINE hmm_dVec2 &operator*=(hmm_dVec2 &Left, double Right)
{
    ASSERT_COVERED(HMM_dMultiplyVec2dAssign);
...
COVERAGE(HMM_dDivideVec2Assign, 1)
HMM_INLINE hmm_dVec2 &operator/=(hmm_dVec2 &Left, hmm_dVec2 Right)
{
    ASSERT_COVERED(HMM_dDivideVec2Assign);
...
COVERAGE(HMM_dDivideVec2fAssign, 1)
HMM_INLINE hmm_dVec2 &operator/=(hmm_dVec2 &Left, float Right)
{
    ASSERT_COVERED(HMM_dDivideVec2fAssign);
    
    return (Left = Left / Right);
}

COVERAGE(HMM_dDivideVec2dAssign, 1)
HMM_INLINE hmm_dVec2 &operator/=(hmm_dVec2 &Left, double Right)
{
    ASSERT_COVERED(HMM_dDivideVec2dAssign);
...
COVERAGE(HMM_dEqualsVec2Op, 1)
HMM_INLINE hmm_bool operator==(hmm_dVec2 Left, hmm_dVec2 Right)
{
    ASSERT_COVERED(HMM_dEqualsVec2Op);
    
    return HMM_PREFIX(dEqualsVec2)(Left, Right);
}
...
COVERAGE(HMM_dEqualsVec2OpNot, 1)
HMM_INLINE hmm_bool operator!=(hmm_dVec2 Left, hmm_dVec2 Right)
{
    ASSERT_COVERED(HMM_dEqualsVec2OpNot);
...
COVERAGE(HMM_dUnaryMinusVec2, 1)
HMM_INLINE hmm_dVec2 operator-(hmm_dVec2 In)
{
    ASSERT_COVERED(HMM_dUnaryMinusVec2);
