/* date = March 26th 2022 4:20 pm */

#ifndef BASE_BUILD_DEFINES_H
#define BASE_BUILD_DEFINES_H
...
# define LANG_CPP 1
# define BEGIN_NAME_MANGLING_DISABLE extern "C" {
# define c_internal extern "C" internal
# define END_NAME_MANGLING_DISABLE }
#else
# define LANG_C 1
#endif
